    ...
    var branchSportsValidation = function() {
            ...
            formBranchSports.validate({
                ...
                errorPlacement: function (error, element) { // render error placement for each input type
                    ...
                    if(successBranchSports.is(":visible")){
                        var errors = 0;
                        formBranchSports.each(function(){
                ...
                success: function (label, element) {
                    ...
                    if(errorBranchSports.is(":visible")){
                        var errors = 0;
                        formBranchSports.each(function(){
                            if($(this).find('.form-group').hasClass('has-error')){
                                errors += 1;
 ...
 */
 ...
 var ImageHandler = function () {
    ...
    $("input:file").change(function (e){                
        ...
        // Check if all requirement valid and show success text
        if(errorBranchSports.is(":visible") || successBranchSports.is(":visible")){
            var errors = 0;
            formBranchSports.each(function(){
                if($(this).find('.form-group').hasClass('has-error')){
                    errors += 1;
