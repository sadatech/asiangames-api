	    ...
	    <div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject font-green sbold uppercase">SCHEDULES</span>
				</div>
	        </div>
	        <div class="portlet-body" style="padding: 15px;">
	        	...
	        	<div class="table-toolbar">
                	<div class="row">
                    	<div class="col-md-6">
                        	<div class="btn-group">
                             	<a class="btn green" href="{{ url('schedules/create') }}"><i
	        	...
	        	<table class="table table-striped table-hover table-bordered" id="schedulesTable" style="white-space: nowrap;">
                	<thead>
                    	<tr>
                    		<th> No. </th>                            
                        	<th> Code </th>
...
<script>
	$(document).ready(function () {    	
        ...
        $('#schedulesTable').on('click', 'tr td button.deleteButton', function () {
            var id = $(this).val();

            if(scheduleScheduleDetailsRelation(id) > 0){
