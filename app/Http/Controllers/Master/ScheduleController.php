...
class ScheduleController extends Controller
{
    ...
    public function makeTable($data){
        ...
        return Datatables::of($data)
                ->editColumn('description', function ($item) {
                    ...
                    return
                    "<a class='open-description-modal' data-target='#full-width' data-toggle='modal' data-title='".$item->code." description' data-description='".$description."' style='color: black;text-decoration: none;'> ".str_limit($item->description, 50)." </a>";                   
                })
    ...
    public function store(Request $request)
    {
        ...
        // Untuk sementara datetime pake now dlu
